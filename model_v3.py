...
def engineer_features(df):
    ...
    keep = ['Pclass','Sex','Age','Fare','FarePerPerson','FamilySize','IsAlone','Title','Embarked','PclassSex','AgeClass','IsChild','IsWoman','WomanOrChild']
    return df[keep]
...
sub_path = rf'C:\Users\abhishek\submissions\submission_v3_{scores.mean():.4f}.csv'
